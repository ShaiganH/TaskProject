...
import {
  ...
  Download, LogOut, Shield, User, ChevronRight, Menu, X
} from 'lucide-react'
...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Mobile drawer */}
      <aside className={`lg:hidden fixed top-0 left-0 bottom-0 z-50 w-64 bg-white border-r border-gray-100 flex flex-col h-screen transition-transform duration-200 ${mobileOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <SidebarContent />
      </aside>
