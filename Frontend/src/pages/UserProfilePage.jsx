      ...
      <div className="card p-5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <StatPill
            ...
            value={profile.taskStats?.total ?? 0}
          />
          <StatPill
            label="In progress"
            value={profile.taskStats?.inProgress ?? 0}
            color="text-blue-600"
          />
          <StatPill
            label="Completed"
            value={profile.taskStats?.completed ?? 0}
            color="text-green-600"
          />
          <StatPill
            label="Overdue"
            value={profile.taskStats?.overdue ?? 0}
            color={
              profile.taskStats?.overdue > 0 ? "text-red-500" : "text-gray-700"
            }
          />
        </div>
      </div>
